        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="text-end">
                            <a href="{{ route('feature_add') }}" role="button" class="btn btn-primary btn-sm">
                                <i class="bi bi-bookmark-star me-2"></i> ADD FEATURE</a>
                        </div>
                        <hr>
                        <table class="table datatable table-sm" id="featureList">
                            <thead>
                                <tr>
                                    <th scope="col">SL.</th>
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<i class="bi ${data} h3" style="color: ${row.color}"></i>`;
                        }
                    },
                    {
                        "data": "title",
                    ...
                    },
                    {
                        ...
                        "name": "actions",
                        "render": function(data, type, row) {
                            let editUrl = `/feature-edit/${data}/edit`;
                            ...
                            data-id="${data}" data-url="feature-delete"><i class="bi bi-trash"></i></button>`;
                            return buttons;
                        }
                    }
                ],
